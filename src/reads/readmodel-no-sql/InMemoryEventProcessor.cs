...
{
    /// <summary>
    /// Class responsible for processing events generated by aggregates, and update the read model
    /// accordingly.
    /// </summary>
        ...
        IPublisher<TodoRemoved>
    {
        ...
        private readonly ILogger<InMemoryEventProcessor> logger;

        public InMemoryEventProcessor(ConnectionString connectionString, ILogger<InMemoryEventProcessor> logger)
        {
